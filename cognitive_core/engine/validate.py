...
From code:
    from cognitive_core.engine.validate import validate_all, validate_workflow, validate_domain
...
VALID_PRIMITIVES = {
    "retrieve", "classify", "investigate", "deliberate",
    "verify", "generate", "challenge", "govern",
}
...
def _load_required_params() -> dict[str, list[str]]:
    ...
    try:
        ...
        return {
            ...
            "govern": ["workflow_state", "governance_context"],
        }
