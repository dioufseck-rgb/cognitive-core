...
Usage:
    from cognitive_core.engine.health import HealthChecker, run_health_server
...
def check_config_valid() -> tuple[bool, str]:
    ...
    try:
        from cognitive_core.engine.llm import validate_config
...
def check_spec_valid(root: str = ".") -> tuple[bool, str]:
    ...
    try:
        from cognitive_core.engine.validate import validate_all
...
def create_llm_check(provider: str | None = None) -> CheckFn:
    ...
    def check() -> tuple[bool, str]:
        try:
            from cognitive_core.engine.llm import create_llm, detect_provider
