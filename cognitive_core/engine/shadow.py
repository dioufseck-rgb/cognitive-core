...
class ShadowMode:
    ...
    When enabled, Govern primitives are intercepted: the full proposed
    ...
    def __init__(
        ...
        if self._enabled:
            logger.info("Shadow mode ENABLED — Govern primitives will be logged but not executed")
    ...
    def should_skip_act(self, primitive: str) -> bool:
        """Check if this primitive should be skipped (only Govern in shadow mode)."""
        return self._enabled and primitive == "govern"
