...
Implements TraceCallback protocol from cognitive_core.engine.nodes to emit structured
...
Usage:
    from cognitive_core.engine.logging import StructuredLogger, configure_logging
