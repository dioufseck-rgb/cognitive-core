...
class GovernancePipeline:
    ...
    def protected_llm_call(
        ...
        # ── 3b. Normalise response content ──────────────────────────────
        # LangChain model responses vary by provider and version:
        #   - Most models: response.content is a plain str
        #   - Newer Gemini / multimodal models: response.content is a list
        #     of content blocks, e.g. [{"type": "text", "text": "..."}]
        #     or [{"type": "text", "text": "..."}, {"type": "tool_use", ...}]
        #   - Some wrappers: response.content is already parsed JSON
        # Extract to a single string regardless of what came back.
