    ...
    def _execute_workflow(
        ...
        def _step_log_callback(step_name, step_output, state):
            try:
                ...
                # step_output IS the output dict (contains primitive, step_name,
                # artifact, finding, etc.). Do not unwrap a nested "output" key —
                # there is none. The double-unwrap was silently producing empty dicts.
                output = {k: v for k, v in step_output.items()
