...
class CoordinatorStore:
    ...
    def __init__(self, db_path: str | Path = "coordinator.db", db_backend=None):
        ...
        if db_backend is not None:
            ...
            from cognitive_core.engine.db import create_backend
    ...
    def _create_tables(self):
        self.db.executescript("""
            CREATE TABLE IF NOT EXISTS instances (
                ...
                governance_tier_locked INTEGER NOT NULL DEFAULT 0,
        ...
        try:
            self.db.execute(
                "ALTER TABLE instances ADD COLUMN governance_tier_locked INTEGER NOT NULL DEFAULT 0"
            )
            self._commit()
        except Exception:
    ...
    def save_instance(self, inst: InstanceState):
        ...
        """, (
            ...
            1 if inst.governance_tier_locked else 0,
    ...
    def _row_to_instance(self, row) -> InstanceState:
        return InstanceState(
            ...
            governance_tier_locked=bool(row["governance_tier_locked"]),
