...
class InstanceState:
    ...
    # If True, the tier was explicitly set by a delegation governance_tier_override
    # and must not be escalated by quality gate or other automatic mechanisms.
    governance_tier_locked: bool = False
    ...
    def create(
        ...
        return InstanceState(
            ...
            governance_tier_locked=governance_tier_locked,
        )
...
class DelegationPolicy:
    ...
    # Optional governance tier override for the handler.
    # If set, overrides the handler domain's default tier.
    # If empty, handler uses its domain's tier as normal.
    governance_tier: str = ""
